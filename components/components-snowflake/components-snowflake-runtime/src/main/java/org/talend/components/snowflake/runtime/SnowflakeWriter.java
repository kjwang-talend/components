...
public class SnowflakeWriter implements WriterWithFeedback<Result, IndexedRecord, IndexedRecord> {
    ...
    private void execTableAction(Object datum) throws IOException {
        ...
        if (selectedTableAction != TableActionEnum.TRUNCATE) {
            ...
            try {
                ...
                if(connectionProperties.isShowAlternativeSchemaProperty() && connectionProperties.getReferencedConnectionProperties() != null && connectionProperties.useAlternativeSchema.getValue()) {
    ...
    public static Map<LoaderProperty, Object> getLoaderProps(
        ...
        if(connectionProperties.getReferencedComponentId() != null) {
            if(connectionProperties.isShowAlternativeSchemaProperty() && connectionProperties.useAlternativeSchema.getValue()) {
                schemaName = connectionProperties.alternativeSchemaName.getValue();
            } else {
